...
public class ComentarioProduto  implements java.io.Serializable {
    ...
    /**
     * Gets the comentario value for this ComentarioProduto.
     * 
     * @return comentario
     */
    ...
    /**
     * Sets the comentario value for this ComentarioProduto.
     * 
     * @param comentario
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.fiap.com.br/", "comentarioProduto"));
